...
class StatusFile : FileDef {
	...
	StatusFile() {
		...
		block("Status", doc="A type of status effect that can be added to an object.",
			...
			field("Show Duration", AT_Boolean, "False", doc="The duration of instances of this status should be visible to end users. (NB: Only implemented for status boxes on ships and planets)");
	}
